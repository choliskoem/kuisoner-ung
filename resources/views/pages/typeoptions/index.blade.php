                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($typeoptions as $typeoption)
                                            <tr>
                                                <td>{{ $typeoption->name_type }}</td>
                                                <td>{{ $typeoption->name_option }}</td>
                                                <td>{{ $typeoption->created_at }}</td>

                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        {{-- <a href="{{ route('type.edit', $typeoption->id_type) }}"
                                                            class="btn btn-sm btn-info btn-icon">
                                                            <i class="fas fa-edit"></i>
                                                            Edit
                                                        </a> --}}
                                                        <form
                                                            action="{{ route('typeoption.destroy', $typeoption->id_type_option) }}"
