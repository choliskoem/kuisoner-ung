        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    You can manage all Options, such as editing, deleting and more.
                </p>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="{{ route('option.edit', $option->id_option) }}"
                                                            class="btn btn-sm btn-info btn-icon">
                                                            <i class="fas fa-edit"></i>
                                                            Edit
                                                        </a>
                                                        <form action="{{ route('option.destroy', $option->id_option) }}"
